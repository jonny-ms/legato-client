      ...
      <CssBaseline />
        <Container className={classes.container}>
          <Card style={{ padding: "10%", borderRadius: 7 }} elevation={4}>
            ...
            <Grid container
              ...
              <Grid item>
                <Avatar
                  ...
                  className={props.mobile ? classes.mobileAvatar : classes.bigAvatar}
                  />
              </Grid>
            </Grid>
            ...
            <Box className={classes.textBox}>
              <Typography gutterBottom variant={props.mobile ? "subtitle1" : "h6"} component="h2" color="textSecondary">
                {teacher.tagline}
              </Typography>
            </Box>
